...
در صورتی که از ابتدا این اصول رعایت می‌شد:

- برای اضافه کردن **SMS**، تغییرات ۱ و ۲ حذف می‌شدند
- تغییر ۴ هم به جای تغییر دادن switch case، تبدیل می‌شد به اضافه کردن یک case در factory
- برای اضافه کردن **Pay ONSITE**، تغییر ۷ تبدیل به اضافه کردن به factory می‌شد


### گام ۵: جمع‌بندی

به کار بردن این اصول در این پروژه باعث شد که:

- تعداد تغییراتی که لازم است هنگام ایجاد فیچر جدید اعمال کنیم **کمتر** شود
- تغییراتی که باید در پروژه اعمال کنیم **معنادارتر** شوند

با رعایت اصول SOLID، برای اضافه کردن فیچر جدید (مثل SMS یا پرداخت ONSITE) فقط نیاز به ایجاد کلاس‌های جدید و اضافه کردن case در Factory است، بدون نیاز به تغییر کلاس‌های موجود. این رویکرد باعث می‌شود که کد **قابل نگهداری‌تر**، **قابل توسعه‌تر** و **قابل تست‌تر** باشد.